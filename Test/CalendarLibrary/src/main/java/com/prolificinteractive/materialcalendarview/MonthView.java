...
/**
 * Display a month of {@linkplain DayViewGroup}s and
...
class MonthView extends CalendarPagerView {
    ...
    public MonthView(@NonNull MaterialCalendarView view, CalendarDay month, int firstDayOfWeek, boolean isShowTitle) {
        super(view, month, firstDayOfWeek, isShowTitle);
    }

    @Override
    protected void buildDayViews(Collection<DayViewGroup> dayViews, Calendar calendar) {
